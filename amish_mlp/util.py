...
model= gensim.models.KeyedVectors.load_word2vec_format('/home/amish/Desktop/major/amish_mlp/google_news/GoogleNews-vectors-negative300.bin.gz',limit=500000, binary=True)
